package com.hly.march.controller;

import com.hly.march.entity.BlogSeries;
import com.hly.march.entity.Msg;
import com.hly.march.entity.User;
import com.hly.march.exception.MyNoPermissionException;
import com.hly.march.exception.MyNotFoundException;
import com.hly.march.realm.ShiroHelper;
import com.hly.march.service.IBlogSeriesService;
import com.hly.march.service.IBlogService;
import com.hly.march.service.IUserService;
import com.hly.march.utils.MD5;
import com.hly.march.utils.MyBase64Utils;
import com.hly.march.utils.WrappedBeanCopier;
...
public class UserController {
    ...
    public Msg updateUser(@Validated({UserController.Update.class}) User updateUser, BindingResult result) throws MyNoPermissionException {
        if(result.hasErrors()){
            // 校验失败

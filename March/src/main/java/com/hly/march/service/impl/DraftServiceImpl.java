...
import com.hly.march.controller.BlogController;
import com.hly.march.dao.DraftMapper;
import com.hly.march.dto.BlogSearchDTO;
import com.hly.march.entity.*;
import com.hly.march.service.IBlogSeriesService;
import com.hly.march.service.IBlogTypeService;
import com.hly.march.service.IDraftService;
import com.hly.march.service.IUserService;
import com.hly.march.utils.DateUtils;
    ...
    public Msg insertDraftWithCheck(Draft draft) {
        ...
        if (draft.getNewType() != null) {
            ...
            if (blogTypeList.size() > 0) {
                ...
                // 如果没有就要新建
                Integer newTypeId = blogTypeService.insertTypeByInitial(draft.getNewType().trim(), draft.getUserId());
                draft.setNewType(null);
                draft.setBlogType(newTypeId);
            }
        }
        if (draft.getNewSeries() != null) {
            ...
            if (blogSeriesList.size() > 0) {
                ...
                // 如果没有就要新建
                Long newSeriesId = blogSeriesService.insertSeriesByInitial(draft.getNewSeries().trim(), draft.getUserId(), draft.getBlogType(), draft.getBlogIntro());
                draft.setNewSeries(null);

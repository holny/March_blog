            ...
            if(result.code==100){
                ...
                $.each(seriesList, function (index, item) {
                    if(checkIsNullOrEmpty(defaultValue)&&defaultValue==item.seriesId){
                        // console.log('series Id default value='+defaultValue+'  item.seriesId='+item.seriesId+'  item.seriesName:'+item.seriesName);
...
function blog_modify_checkbox(elem,mode) {
    console.log("blog_modify_checkbox");
    console.log(elem);
    let selector;
    let input;
    if(mode=="series") {
    ...
    if (elem.prop("checked")) {
        console.log('blog_modify_checkbox checked');
        if(input.length>0){
...
function validate_data(target, pattern) {
    ...
    if (pattern == "email") {
        ...
        console.log("validate_data--name--tartget:"+target);
...
function user_info_area_init(userInfo,userInfoArea) {
    console.log("user_info_area_init");
...
function init_sidebar_summary(summary,area) {
    console.log("init_sidebar_summary");
    console.log(summary);
...
function like_click(elem,blogId,nowCount) {
    console.log("like_click--blogId="+blogId);
